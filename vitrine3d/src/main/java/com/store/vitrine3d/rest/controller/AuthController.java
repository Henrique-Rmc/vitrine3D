...
public class AuthController {
    ...
    @Operation(summary = "Autentica o lojista — retorna access token no body e refresh token em cookie httpOnly")
    @PostMapping("/login")
    public ResponseEntity<LoginResponse> login(@Valid @RequestBody LoginRequest request) {
        ...
        return ResponseEntity.ok()
                ...
                .body(new LoginResponse(accessToken, store.getId(), store.getEmail(), store.getStoreName()));
    }
