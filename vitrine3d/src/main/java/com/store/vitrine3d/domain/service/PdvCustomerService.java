...
public interface PdvCustomerService {
    ...
    List<PdvCustomerRelationship> listRelationships(UUID storeId, UUID customerId);
    PdvCustomerRelationship addRelationship(UUID storeId, UUID customerId, PdvCustomerRelationshipRequest request);
    void removeRelationship(UUID storeId, UUID customerId, Long relationshipId);
}
