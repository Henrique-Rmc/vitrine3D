...
public class PdvSaleItem {
    ...
    private PdvSale sale;

    // Nullable: produto pode ser deletado depois da venda
    ...
    public PdvSale getSale() { return sale; }
    public void setSale(PdvSale sale) { this.sale = sale; }
